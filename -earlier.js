...
function listProductToBuy() {
    ...
    document.getElementById("mainVarukorg").innerHTML += `
        <div class="flexItem" id="flexItem${i}">
            <div id="produktVal">
            ...
            <div class="button">
                <button class="buttonDelete" id="deleteBtn${i}"><img src="imgs/icon_trashBin.png" height="16px">Ta bort</button>
            </div>
        </div>
    `
...
function deleteProduct(indexToDelete) {
    ...
    productsToBuy.splice(indexToDelete, 1)
